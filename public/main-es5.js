...
var FormListComponent = /** @class */ (function () {
    function FormListComponent(clienteService, router) {
    ...
    FormListComponent.prototype.listAll = function () {
        var _this = this;
        this.clienteService.getList().subscribe(function (cliente) { return _this.clientes = cliente; });
    };
    FormListComponent.prototype.listKpi = function () {
        var _this = this;
        this.clienteService.getKpiClientes().subscribe(function (kpi) { return _this.kpiClientes = kpi; });
    };
    FormListComponent.prototype.delete = function (cliente) {
        var _this = this;
        this.clienteService.delete(cliente).subscribe(function (Response) {
            _this.listAll();
        }, function (err) {
            _this.listAll();
...
var FormService = /** @class */ (function () {
    ...
    FormService.prototype.getKpiClientes = function () {
        return this.http.get(this.url + '/kpideclientes');
    };
    FormService.prototype.save = function (cliente) {
    ...
    FormService.prototype.update = function (cliente) {
...
var FormComponent = /** @class */ (function () {
    function FormComponent(formService, router, route) {
    ...
    FormComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (param) {
            ...
            if (Object.keys(param).length < 1) {
                _this.hasParams = false;
            }
            else {
                _this.hasParams = true;
                _this.cliente.id = param.id;
                _this.cliente.nombre = param.nombre;
                _this.cliente.apellido = param.apellido;
                _this.cliente.edad = param.edad;
                _this.cliente.fechaNac = param.fechaNac;
            }
        });
    };
    FormComponent.prototype.saveCliente = function () {
        var _this = this;
        this.formService.save(this.cliente).subscribe(function (cliente) {
            _this.router.navigate(['list']);
        }, function (err) {
            _this.router.navigate(['list']);
        });
    };
    FormComponent.prototype.updateCliente = function () {
        var _this = this;
        this.formService.update(this.cliente).subscribe(function (cliente) {
            _this.router.navigate(['list']);
        }, function (err) {
            _this.router.navigate(['list']);
        });
